...
from metrics.metrics_auxiliar.run_and_extract import get_ttfaf_and_ttff_matrixSBF
from metrics.metrics_auxiliar.predefined_plots import plot_ttff_vs_ttfaf

DATA_FOLDER = OSNMALIB_PATH / 'metrics/scenarios/TTFF_test/'
